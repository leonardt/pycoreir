...
from coreir.simulator import CORESimulatorState_p, CORESimValue_p
...
libcoreir_c.CORESimSetValue.argtypes = [CORESimulatorState_p, ct.POINTER(ct.c_char_p), ct.c_int, ct.POINTER(ct.c_bool)]
...
libcoreir_c.CORESimSetWatchPoint.argtypes = [CORESimulatorState_p, ct.POINTER(ct.c_char_p), ct.c_int, ct.POINTER(ct.c_bool)]
libcoreir_c.CORESimSetWatchPoint.restype = None
